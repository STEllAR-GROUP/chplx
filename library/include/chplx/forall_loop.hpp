...
namespace chplx {
    ...
    namespace detail {
        ...
        template <typename ExPolicy, typename Tuple, typename F,
            typename... Args>
        void forall(ExPolicy&& policy, Tuple& t, F&& f, Args&&... args)
        {
            ...
            if constexpr (std::tuple_size_v<base_tuple> != 0)
            {
                ...
                {
                    hpx::ranges::for_each(std::forward<ExPolicy>(policy),
    ...
    template <typename ExPolicy, typename... Ts, typename F, typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
        Tuple<Ts...>& t, F&& f, Args&&... args)
    {
        detail::forall(std::forward<ExPolicy>(policy), t,
    ...
    template <typename ExPolicy, typename... Ts, typename F, typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
        Tuple<Ts...> const& t, F&& f, Args&&... args)
    {
        detail::forall(std::forward<ExPolicy>(policy), t,
            hpx::annotated_function(
                std::forward<F>(f), detail::generate_annotation(location)),
    ...
    template <typename ExPolicy, typename T, BoundedRangeType BoundedType,
        bool Stridable, typename F, typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
    ...
    template <typename ExPolicy, int N, typename T, bool Stridable, typename F,
        typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
        Domain<N, T, Stridable> const& d, F&& f, Args&&... args)
    {
        auto wrapped = hpx::annotated_function(
            std::forward<F>(f), detail::generate_annotation(location));
    ...
    template <typename ExPolicy, typename T, typename F, typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
        AssocDomain<T> const& d, F&& f, Args&&... args)
    {
        auto wrapped = hpx::annotated_function(
            std::forward<F>(f), detail::generate_annotation(location));
    ...
    template <typename ExPolicy, typename... Rs, typename F, typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
    ...
    template <typename ExPolicy, typename T, typename Domain, typename F,
        typename... Args>
        requires(hpx::is_execution_policy_v<std::decay_t<ExPolicy>>)
    void forall(ExPolicy&& policy, hpx::source_location const& location,
    ...
    void forall(
        hpx::source_location const& location, Target&& t, F&& f, Args&&... args)
    {
        forall(hpx::execution::par, location, std::forward<Target>(t),
            std::forward<F>(f), std::forward<Args>(args)...);
    }

    template <typename Target, typename F, typename... Args>
        requires(!std::is_same_v<std::decay_t<Target>, hpx::source_location> &&
            !hpx::is_execution_policy_v<std::decay_t<Target>>)
    void forall(Target&& t, F&& f, Args&&... args)
    {
        forall(hpx::execution::par, HPX_CURRENT_SOURCE_LOCATION(),
            std::forward<Target>(t), std::forward<F>(f),
            std::forward<Args>(args)...);
    }
}    // namespace chplx
